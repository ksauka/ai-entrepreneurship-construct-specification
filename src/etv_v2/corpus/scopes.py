...
from etv_v2.corpus.query_provenance import SEARCH_QUERIES
...
DATASET_SCOPES: tuple[DatasetScope, ...] = (
    DatasetScope("full_corpus", "Full corpus", None),
    *(
...
# Bonus scope: the strict AI x entrepreneurship subset flagged in Stage 1.5.
STRICT_AI_ENT_SCOPE = DatasetScope(
    "strict_ai_ent", "Strict AI x entrepreneurship", "ai_ent_relevant"
)
